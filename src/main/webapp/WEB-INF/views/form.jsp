...
color: rgb(204, 153, 102);
  ...
  text-shadow: text-shadow:
	...
	font-family: Comic sans, Comic Sans MS, cursive; 
		background: url("https://55mm.co/wp-content/uploads/Spilled-Coffee-Beans-Main.jpg");
	}
	...
	<form action="username" onsubmit="return validate();">
		<fieldset>
			...
			<input id="firstname" type="text" name="firstName"
				...
				id="lastname" type="text" name="lastName" placeholder="last name" /><br>
			Email: <br>
			<input id="email" type="text" name placeholder="e-mail address" /><br>
			Phone Number: <br> <input type="tel" placeholder="123-456-7890"
				pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required /><br>
			<!--  password: <br> <input id = "pass1" type="password" placeholder="password"/><br>
		confirm password: <br> <input id = "pass2" type="password" placeholder="confirm password" required/><br>
		Are you 18 years or older <br>
		<input type ="radio" name = "answer" value = "Age">Yes<br>
	  ...
	  Select your favorite Coffee House drink:<br>
	  <select>
